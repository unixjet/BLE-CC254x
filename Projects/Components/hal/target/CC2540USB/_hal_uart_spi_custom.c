...
#define SPI_MAX_PKT_LEN            (256+128)//256
...
// HAL CUSTOM Configuration
#define PxIEN                      P1IEN
#define PxIFG                      P1IFG
#define PxIF                       P1IF
#define SPI_RDYIn                  P1_7
#define SPI_RDYIn_BIT              BV(7)
...
//  UxGCR =  15;                       /* Cfg for the max Rx/Tx baud of 2-MHz */
  UxGCR =  17;                       /* Cfg for the max Rx/Tx baud of 8-MHz */
  UxBAUD = 255;
#elif !defined HAL_SPI_MASTER
